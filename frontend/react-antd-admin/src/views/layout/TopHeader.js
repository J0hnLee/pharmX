		...
		return (
			<div className="top-header">
				<div className="top-header-inner">
					...
					<div className="header-title">藥局 POS 通用後台管理系统</div>
				...
				{tags.show ? <Tags /> : null}
				<BasicDrawer title="系統設置" closable onClose={this.onClose} visible={this.state.visible} onChangeTags={this.onChangeTags} onChangeBreadCrumb={this.onChangeBreadCrumb} onChangeTheme={this.onChangeTheme} {...this.props} />
			</div>
		);
	}
}
